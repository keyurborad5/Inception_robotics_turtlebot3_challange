...
def generate_launch_description():
    ...
    declare_first_tb3_x_pos_arg = DeclareLaunchArgument('first_tb3_x_pos', default_value='0.0')
    declare_first_tb3_y_pos_arg = DeclareLaunchArgument('first_tb3_y_pos', default_value='0.0')
    ...
    declare_second_tb3_x_pos_arg = DeclareLaunchArgument('second_tb3_x_pos', default_value='0.0')
    declare_second_tb3_y_pos_arg = DeclareLaunchArgument('second_tb3_y_pos', default_value='-1.0')
    ...
    declare_third_tb3_x_pos_arg = DeclareLaunchArgument('third_tb3_x_pos', default_value='0.0')
    declare_third_tb3_y_pos_arg = DeclareLaunchArgument('third_tb3_y_pos', default_value='1.0')
    ...
    def create_tb3_group(namespace, x_pos, y_pos, z_pos, yaw,sdf_path):
        return GroupAction([
            Node(
                ...
                parameters=[{
                    ...
                    #     'xacro ', os.path.join(
                    #         get_package_share_directory('aws_robomaker_bookstore_world'),
                    #         'urdf', f'turtlebot3_{LaunchConfiguration("model")}.urdf.xacro'
                    #     )
                    # ]),
            ...
            Node(
                ...
                # # name='spawn_entity_'+ f'{namespace.describe()[14:17]}',
                # namespace='keyur',
                arguments=[
                    '-file', sdf_path,
                    '-entity', namespace, 
    ...
    return LaunchDescription([
        ...
        create_tb3_group(LaunchConfiguration('first_tb3'), 
                         ...
                         LaunchConfiguration('first_tb3_yaw'),sdf_path0),
        create_tb3_group(LaunchConfiguration('second_tb3'), 
                         ...
                         LaunchConfiguration('second_tb3_yaw'),sdf_path1),
        create_tb3_group(LaunchConfiguration('third_tb3'), 
                         ...
                         LaunchConfiguration('third_tb3_yaw'),sdf_path2)
    ])
